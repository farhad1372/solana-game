  ...
  <vs-card type="0" class="mb-4 w-100">
    <template #text>
      <vs-table>
        <template #header>
          <div
            class="d-flex justify-space-between align-center px-0 px-sm-1 px-md-2 border-bottom flex-wrap"
          >
            <div class="my-0 py-0">
              <div class="text-white h4 fw-600">{{ title }}</div>
